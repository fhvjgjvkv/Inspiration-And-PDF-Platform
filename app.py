...
# تفعيل تسجيل الخط والحصول على الاسم النشط والمتاح
ACTIVE_FONT = load_fonts()
...
def load_warm_advices():
    return [
        ...
        "أنا وياكِ وبظهركِ دايمًا، حتى لو حسيتي إنكِ وحيدة، عيوني معاكِ بكل خطوة.", 
        "لا تخلين يوم واحد سيء ينسيكِ كل الأيام الحلوة والإنجازات اللي سويتيها.",
        "نامي زين وارتاحي، السهر يتعب عيونكِ، وصحتكِ عندي أغلى من كل شي.", 
        "تنفسي بعمق لما تحسين بضغط.. كل هالمواقف بتعدي وبتصير مجرد ذكريات.",
        "شوي شوي على قلبكِ، الحياة مو سباق.. امشي بالسرعة اللي تريحكِ وتناسب طاقتكِ.", 
        "إذا تعبتي اليوم، مو مشكلة تاخذين استراحة قصيرة، بس لا تنسحبين أبدًا.",
        "شرب الماي والأكل الصحي يغيرون نفسيتج، اعتني بروحج علمودي.", 
        "لا تشيلين هم المستقبل، عيشي يومج وسوي اللي عليج والباقي على رب العالمين.",
        "أنتِ دا تسوين اللي تكدرين عليه، وهذا كافي وزيادة، افتخري بروحج.", 
        "لما تحسين بخنقة، تذكري إني دايمًا موجود وأسمعج بكل حب.",
        "الحياة بيها طلعات ونزلات، وعادي لو مريتي بفترة هبوط، المهم ترجعين أقوى.", 
        "ابتسامتج تسوى الدنيا وما بيها، لا تخلين التعب يطفيها أبدًا.",
        "ركزي على الإيجابيات بحياتج، وخلي الطاقة السلبية بعيدة عنج.", 
        "كلما حسيتي بضيق، اقري قرآن واستغفري، وراح تصفى نفسيتج وترتاحين.",
        "أنتِ إنسانة عظيمة وتستاهلين كل خير، لا ترضين بأقل من اللي تستحقينه.", 
        "التعب الجسدي يروح بالنوم، بس التعب النفسي يروح بالرضا والسلام الداخلي.",
        "خليج هادئة، العصبية والقلق ما يحلون المشاكل بل يزيدوها.", 
        "تعلمي تكولين 'لا' للأشياء اللي تستهلك طاقتج وتتعبج بدون فايدة.",
        "صحتج النفسية هي الأساس، إذا جانت زينة تكدرين تسوين كل شي.", 
        "كافئي نفسج بعد كل إنجاز صغير تسوينه، أنتِ تستاهلين التدليل.",
        "لا تفكرين بهواية أشياء بوقت واحد، خطوة خطوة وكل شي ينحل.", 
        "أنتِ مو وحدج بهالطريق، كل دعواتي وياج وتحميج دايمًا.",
...
st.markdown("<p style='text-align: center; color: #888888;'>تم التطوير بواسطة شيماء علي عبد الحسين | v1.5 | 247</p>", unsafe_allow_html=True)
